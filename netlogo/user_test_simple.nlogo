extensions [http-req]
globals [adj key prevkey prevtime timelog currtime simul]
...
to setup-turtles
  ...
  set adj [[1 3 4 5 6][0 2 4 8 7][1 3 5 7 9][0 2 6 8 9]
...
to show-key
  ...
  ifelse
  key < 4 [ask turtle key [set color red]]
  [
    foreach item key adj [x -> ask turtle x [set color red]]
  ]
end

to update [current-node next-size]
  set key item random next-size item current-node adj
  show-key
  set prevkey -1
  set timelog word timelog ", "
  set timelog word timelog date-and-time
...
to show-h
  let hturtles []
  set hturtles (turtle-set turtle 1 turtle 2 turtle 3)
  ask hturtles [show-turtle]
  ask turtle 0 [hide-turtle]
end

to show-j
  let hturtles []
  set hturtles (turtle-set turtle 0 turtle 2 turtle 3)
  ask hturtles [show-turtle]
  ask turtle 1 [hide-turtle]
end

to show-k
  let hturtles []
  set hturtles (turtle-set turtle 1 turtle 0 turtle 3)
  ask hturtles [show-turtle]
  ask turtle 2 [hide-turtle]
end

to show-l
  let hturtles []
  set hturtles (turtle-set turtle 1 turtle 2 turtle 0)
  ask hturtles [show-turtle]
  ask turtle 3 [hide-turtle]
end
