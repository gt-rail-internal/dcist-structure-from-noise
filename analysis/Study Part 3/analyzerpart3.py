...
USERNAME = ["A2KOXR5OXIFUIW", "A3IXWFXJC2YKU7", "AVIEE6LDH0BT5", "A122UC2R9WJK0C", "AHOMJD126KTW9"]# ["A3H7GCFS21E253", "AN15QS1604XRS","A141CB4BKDYKDF","A32W2O02CUQ2TO"]
...
def graphtwo(scoresYList, pointscoresList, data, actionList, pointactionList):
    ...
    ax.set_title('Score over Time (Faster is better)')
